...
public class Communicator implements SerialPortEventListener {
	...
	public Communicator(final GUI window) {
		this.window = window;
	}
	...
	public void searchForPorts() {
		...
		while (ports.hasMoreElements()) {
			final CommPortIdentifier curPort = (CommPortIdentifier) ports
					.nextElement();
	...
	public void connect() {
		final String selectedPort = (String) window.cboxPorts.getSelectedItem();
	...
	public void writeData(final int leftThrottle, final int rightThrottle) {
		try {
			if (leftThrottle != 0) {
				System.out.println("Communicator.writeData() LEFT");
				output.write(43);
				output.flush();
				output.write(100);
				output.flush();
			} else {
				System.out.println("Communicator.writeData() RIGHT");
				output.write(45);
				output.flush();
				output.write(101);
				output.flush();
